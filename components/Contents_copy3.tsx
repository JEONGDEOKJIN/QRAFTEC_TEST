...
//       // return lastPage?.[0]?.nextCursor === -1 ? undefined : lastPage?.[0]?.nextCursor;
//       // Ensure lastPage is not empty and has nextCursor
//       if (
//         !lastPage ||
//         lastPage.length === 0 ||
//         lastPage[0].nextCursor === undefined
//       ) {
//         console.log("nextCursor 값이 없어서 undefined 반환");
//         return undefined;
//       }
